...
namespace AllsecureExchange\AllsecureExchange\Test\Unit\Gateway\Config;

use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Framework\Serialize\Serializer\Json;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Magento\Store\Model\ScopeInterface;
use AllsecureExchange\AllsecureExchange\Gateway\Config\Config;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

class ConfigTest extends TestCase
{
    const METHOD_CODE = 'allsecureexchange';
    ...
    /**
     * @covers       \AllsecureExchange\AllsecureExchange\Gateway\Config\Config::getCountryAvailableCardTypes
     * @dataProvider getCountrySpecificCardTypeConfigDataProvider
    ...
    /**
     * @covers \AllsecureExchange\AllsecureExchange\Gateway\Config\Config::isCvvEnabled
     */
