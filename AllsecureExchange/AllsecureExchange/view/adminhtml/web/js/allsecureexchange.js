...
define([
  ...
  'mage/translate',
  'AllsecureExchange_AllsecureExchange/js/validator'
  ...
  return Class.extend({
    ...
    defaults: {
      $selector: null,
      selector: 'edit_form',
      container: 'payment_form_allsecureexchange_creditcard',
      active: false,
      scriptLoaded: false,
      allsecureexchange: null,
      token: null,
      paymentJs: null,
      paymentJsUrl:null,
    ...
    onActiveChange:function (isActive) {
      if (!isActive) {
        this.$selector.off('submitOrder.allsecureexchange_creditcard');
        return;
      }
    ...
    initAllsecureExchangeJs:function(){
      var self=this;
     ...
     */
    initAllsecureExchange: function () {
      $(".allsecureexchange-error").hide();   
    ...
    enableEventListeners: function () {
      this.$selector.on('submitOrder.allsecureexchange_creditcard', this.submitOrder.bind(this));
    },
    ...
    /**
     * Convert card information to allsecureexchange token
     */
    ...
    this.paymentJs.tokenize(
        ...
        function(token, cardData) {
            $('#allsecureexchange_creditcard_transactionToken').val(token);
            defer.resolve();
        }, 
