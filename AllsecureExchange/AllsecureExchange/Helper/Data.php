...
class Data extends AbstractHelper
{
    ...
    const PAYMENT_REDIRECT_CANCEL = 'allsecureexchange/payment/redirect?status=cancel';
    const PAYMENT_REDIRECT_ERROR = 'allsecureexchange/payment/redirect?status=error';
    const PAYMENT_CALLBACK = 'allsecureexchange/payment/callback';
    const SEAMLESS_INTEGRATION = 'payment/allsecureexchange_creditcard/seamless';
    const THREED_SECURE_VERIFICATION = 'payment/allsecureexchange_creditcard/use_3dsecure';
    const ENABLE_SIGNATURE = 'payment/allsecureexchange_creditcard/signature';
    const CURRENT_TRANSACTION_FLAG_IN_MINUTE = 1;
    const MERCHANT_SECRET_KEY = 'payment/allsecureexchange_creditcard/shared_secret';
    const MERCHANT_API_KEY = 'payment/allsecureexchange_creditcard/api_key';
    ...
    const MODULE_PAYMENT = 'AllsecureExchange_AllsecureExchange';
    ...
    const SANDBOX_URL = 'https://asxgw.paymentsandbox.cloud/api/v3/transaction/';
    const PROD_URL = 'https://asxgw.com/api/v3/transaction/';
    const SANDBOX_HOST_URL = 'https://asxgw.paymentsandbox.cloud/';
    const PROD_HOST_URL = 'https://asxgw.com/';
    ...
    public function getGeneralConfigData($field, $storeId = null)
    {
        ...
        /* if (in_array($field, self::ENCRYPTED_CONFIG_FIELDS)) {
            return $this->_encryptor->decrypt($this->getConfigData($field, 'allsecureexchange/general', $storeId));
        } else {
            return $this->getConfigData($field, 'allsecureexchange/general', $storeId);
        } */
    }
    ...
    {
        return '/api/v3/transaction/' . $this->getAllsecureExchangeConfigValue(self::MERCHANT_API_KEY) . $transactionType;
    }
     ...
     * @return string
     */
    public function getAllsecureExchangeConfigValue($configField): string
    {
        $scope = ScopeInterface::SCOPE_STORE;
    ...
    {
        $signatureKey = $this->getAllsecureExchangeConfigValue(self::MERCHANT_SECRET_KEY);
    ...
    {
        return $this->scopeConfig->getValue('allsecureexchange/general/sandbox', ScopeInterface::SCOPE_STORE);
    }
